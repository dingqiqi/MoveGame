package com.dingqiqi.testmove9image.dialog;
...
import com.dingqiqi.testmove9image.activity.MainActivity;
...
public class SelectImageDialog extends DialogFragment {
     ...
     * @param listener 回调
     */
    public void setListener(MainActivity activity, onClickCallBack listener) {
        mActivity = activity;
        mListener = listener;
    }
